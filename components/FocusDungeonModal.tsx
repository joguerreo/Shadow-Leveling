...
export const FocusDungeonModal: React.FC<FocusDungeonModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 overflow-hidden">
      ...
      <div className="relative w-full max-w-lg bg-surface-dark border-2 border-indigo-500/50 rounded-2xl sm:rounded-3xl shadow-[0_0_80px_rgba(99,102,241,0.25)] overflow-hidden flex flex-col h-[90dvh] sm:h-auto sm:max-h-[90vh] animate-modal">
        {/* Header */}
